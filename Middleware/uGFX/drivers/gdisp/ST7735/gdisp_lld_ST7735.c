...
LLDSPEC gBool gdisp_lld_init(GDisplay *g) {
	...
	LLDSPEC gColor gdisp_lld_get_pixel_color(GDisplay *g) {
		unused_(g);
		/* qEdit Warning! We cann't to read from display! */
		ST7735_FillRectangle(0, 0, 160, 26, ST7735_WHITE);
		ST7735_FillRectangle(0, 27, 160, 54, ST7735_BLUE);
		ST7735_FillRectangle(0, 55, 160, 79, ST7735_RED);
